...
namespace DTL\CoolAndBedBundle\Controller;

use DTL\CoolAndBedBundle\AdminList\SatelliteAdminListConfigurator;
...
class SatelliteAdminListController extends AdminListController
{
     ...
     * The index action
     *
     * @Route("/", name="dtlcoolandbedbundle_admin_satellite")
     */
     ...
     * The add action
     *
     * @Route("/add", name="dtlcoolandbedbundle_admin_satellite_add")
     * @Method({"GET", "POST"})
     * @return array
     */
     ...
     * @param int $id
     *
     * @Route("/{id}", requirements={"id" = "\d+"}, name="dtlcoolandbedbundle_admin_satellite_edit")
     * @Method({"GET", "POST"})
     *
     * @return array
     */
     ...
     * @param int $id
     *
     * @Route("/{id}/delete", requirements={"id" = "\d+"}, name="dtlcoolandbedbundle_admin_satellite_delete")
     * @Method({"GET", "POST"})
     *
     * @return array
     */
    ...
    /**
     * @Route("/export.{_format}", requirements={"_format" = "csv"}, name="dtlcoolandbedbundle_admin_satellite_export")
     * @Method({"GET", "POST"})
     * @return array
     */
