 ...
 * SlidePagePart
 *
 * @ORM\Table(name="dtl_coolandbedbundle_slide_page_part")
 * @ORM\Entity
 */
class SlidePagePart extends \Kunstmaan\PagePartBundle\Entity\AbstractPagePart
{
    ...
    {
        return 'DTLCoolAndBedBundle:PageParts:SlidePagePart/view.html.twig';
    }
    ...
    {
        return new \DTL\CoolAndBedBundle\Form\PageParts\SlidePagePartAdminType();
    }
}